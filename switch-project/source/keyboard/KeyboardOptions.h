...
namespace keyboard
{
    ...
    auto constexpr TotalSupportedKeys = (int)KeyParameter::RightArrow + 1;
    ...
    static std::vector<KeyParameter> const ParamsList
    {
        ...
        KeyParameter::Home, KeyParameter::End, KeyParameter::PageUp, 
        KeyParameter::PageDown, KeyParameter::UpArrow, KeyParameter::DownArrow,
